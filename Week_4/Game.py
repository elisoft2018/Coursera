...
def validateWinner(letter):
    """Validación de los valores horizontales"""
    ...
    """Validación de los valores horizontales"""
    if board[0][0] == letter and \
            board[1][0] == letter and \
            board[2][0] == letter:
        return True

    if board[0][1] == letter and \
            board[1][1] == letter and \
            board[2][1] == letter:
        return True

    if board[0][2] == letter and \
            board[1][2] == letter and \
            board[2][2] == letter:
        return True

    """Validación de los valores diagonales"""
    if board[0][0] == letter and \
            board[1][1] == letter and \
            board[2][1] == letter:
        return True
...
def play():
    while True:
        try:
            ...
            print('Opssss Debes enviar dos valores separados por coma ')
            continue
